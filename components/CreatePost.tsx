        ...
        <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
            ...
            <div className="_feed_inner_text_area_box">
                <div className="_feed_inner_text_area_box_image">
                    <img src="/images/user.png" alt="User" className="_txt_img" />
                </div>
                <div className="form-floating _feed_inner_text_area_box_form">
                    <textarea
                        ...
                        disabled={isLoading}
                    ></textarea>
                    {content.trim().length === 0 && <label className="pt-2">
                        Write something ...
            ...
            <div className="_feed_inner_text_area_bottom">
                ...
                <div className="d-flex align-items-center">
                    <select
                        ...
                        style={{ marginRight: '10px', padding: '12px', borderRadius: '10px' }}
                        disabled={isLoading}
                    >
                    ...
                    <button
                        type="button"
                        className="_feed_inner_text_area_btn_link d-flex align-items-center gap-2"
                    ...
                    >
                        ...
                        {isLoading ? <CommonLoader size="16" text="Posting" /> : <span>Post</span>}
                    </button>
                </div>
            </div>
