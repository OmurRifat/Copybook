            ...
            <div className="_layout_right_sidebar_inner">
                <div className="_feed_right_inner_area_card _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                    ...
                    <div className="_feed_bottom_fixed">
                        {[
                            { name: 'Steve Jobs', role: 'CEO of Apple', image: 'people1.png', online: false, time: '5 minute ago' },
                            { name: 'Ryan Roslansky', role: 'CEO of Linkedin', image: 'people2.png', online: true },
                            { name: 'Dylan Field', role: 'CEO of Figma', image: 'people3.png', online: true },
                            { name: 'Steve Jobs', role: 'CEO of Apple', image: 'people1.png', online: false, time: '5 minute ago' },
                            { name: 'Ryan Roslansky', role: 'CEO of Linkedin', image: 'people2.png', online: true },
                            { name: 'Dylan Field', role: 'CEO of Figma', image: 'people3.png', online: true },
                            { name: 'Dylan Field', role: 'CEO of Figma', image: 'people3.png', online: true },
                            ...
                            >
                                <div className="_feed_right_inner_area_card_ppl_box">
                                    <div className="_feed_right_inner_area_card_ppl_image">
                                        <Link href="/profile">
                                            <img src={`/images/${friend.image}`} alt="" className="_box_ppl_img" />
                                        </Link>
                                    </div>
